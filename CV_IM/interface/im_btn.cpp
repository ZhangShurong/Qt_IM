...
Description:  设置最新消息
*************************************************/
void IMBtn::setLatestMessage(const TalkMessage & mes)
{
...
Description: 右键 单击
*************************************************/
void IMBtn::onClickRightButton(/*const QPoint &*/)
{
    if (m_menu == NULL)
    {
        //创建右键菜单
...
Description: 鼠标单击事件
*************************************************/
void IMBtn::mousePressEvent(QMouseEvent *event)
{
...
Description: 鼠标双击事件
*************************************************/
void IMBtn::mouseDoubleClickEvent(QMouseEvent *event)
{
...
Description: 创建右键菜单
*************************************************/
void IMBtn::creatMenu(/*const QList<QString> *groutList*/)
{
